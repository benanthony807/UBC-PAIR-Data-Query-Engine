...
//             TRANSFORMATIONS: {    GROUP: [ "courses_title" ],
//                                     APPLY: [ { overallAvg: { AVG: "courses_avg" } } ] } };
//         assert.equal(transfChecker.isApplySyntaxValid(query), true);
//     });
...
//             TRANSFORMATIONS: {    GROUP: [ "courses_title" ],
//                                     APPLY:  { overallAvg: { AVG: "courses_avg" } } } };
//         assert.equal(transfChecker.isApplySyntaxValid(query), false);
//     });
...
//         assert.equal(transfChecker.isApplySemanticsValid(query), false);
//     });
